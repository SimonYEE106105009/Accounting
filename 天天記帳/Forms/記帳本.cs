    ...
    public partial class 記帳本 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            this.DebounceTime((data) =>
            {
                ...
                {
                    dataGridView1.Rows[i].Cells["Imagepath1_Image"]?.Dispose();
                    dataGridView1.Rows[i].Cells["Imagepath2_Image"]?.Dispose();
                    dataGridView1.Rows[i].Cells["刪除"]?.Dispose();
                }
        ...
        private void LoadDatas()
        {
            ...
            comboBoxColumn1.Name = "Type_combox";
            ...
            comboBoxColumn2.Name = "Purpose_combox";
            ...
            comboBoxColumn3.Name = "Object_combox";
            ...
            comboBoxColumn4.Name = "Store_combox";
            dataGridView1.Columns.Insert(5, comboBoxColumn4);
            dataGridView1.Columns["Type"].Visible = false;
            dataGridView1.Columns["Purpose"].Visible = false;
            ...
            iconColumn1.Name = "Imagepath1_Image";
            ...
            iconColumn2.Name = "Imagepath2_Image";
            ...
            for (int i = 0; i < datas.Count; i++)
            {
                ...
                ((DataGridViewComboBoxCell)dataGridView1.Rows[i].Cells["Type_combox"]).Value = datas[i].Type;
                ((DataGridViewComboBoxCell)dataGridView1.Rows[i].Cells["Object_combox"]).Value = datas[i].Object;
                List<string> purpose = DataModel.keyValuePairs[datas[i].Type];
                DataGridViewComboBoxCell purposebox = (DataGridViewComboBoxCell)dataGridView1.Rows[i].Cells["Purpose_combox"];
                purposebox.DataSource = purpose;
                purposebox.Value = datas[i].Purpose;

                List<string> store = DataModel.keyValueStore[datas[i].Type];
                DataGridViewComboBoxCell storebox = (DataGridViewComboBoxCell)dataGridView1.Rows[i].Cells["Store_combox"];
                storebox.DataSource = store;
                storebox.Value = datas[i].Store;


                ((DataGridViewImageCell)dataGridView1.Rows[i].Cells["Imagepath1_Image"]).Value = map1;
                ((DataGridViewImageCell)dataGridView1.Rows[i].Cells["Imagepath2_Image"]).Value = map2;
                ((DataGridViewImageCell)dataGridView1.Rows[i].Cells["刪除"]).Value = map3;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Columns[e.ColumnIndex].Name == "Imagepath1_Image" || dataGridView1.Columns[e.ColumnIndex].Name == "Imagepath2_Image")
            {
                string imagePath = "";
            ...
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "刪除")
            {
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                datas[e.RowIndex].Number = dataGridView1.Rows[e.RowIndex].Cells["Number"].Value.ToString();
            }
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "Type_combox")
            {
                datas[e.RowIndex].Type = dataGridView1.Rows[e.RowIndex].Cells["Type_combox"].Value.ToString();
            }
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "Purpose_combox")
            {
                datas[e.RowIndex].Purpose = dataGridView1.Rows[e.RowIndex].Cells["Purpose_combox"].Value.ToString();
            }
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "Store_combox") 
            {
                datas[e.RowIndex].Store = dataGridView1.Rows[e.RowIndex].Cells["Store_combox"].Value.ToString();
            }
         
            //HW: 把其他下拉選單連動也一起完成 (也要連動消費店家)
            if (dataGridView1.Columns[e.ColumnIndex].Name == "Type_combox")
            {
                //連動消費目的
                DataGridViewComboBoxCell PurposecomboBoxCell = (DataGridViewComboBoxCell)dataGridView1.Rows[e.RowIndex].Cells["Purpose_combox"]; //第三個位子
                ...
                //連動消費店家
                DataGridViewComboBoxCell StorecomboBoxCell = (DataGridViewComboBoxCell)dataGridView1.Rows[e.RowIndex].Cells["Store_combox"]; //第五個位子
